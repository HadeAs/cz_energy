<template>
  <div class="cs-box-content content">
    <div class="cs-header-content"><img src="@/assets/img/screen/mainA/u1.png">碳排放情况汇总</div>
    ...
    <div class="cs-left-wrap2">
      ...
      <div class="cs-rate">
        <div class="cs-rate-box">
          <span class="cs-rate-label"><img src="@/assets/img/screen/mainA/u79.png">同比</span>
          <span class="cs-rate-num rise"><img src="@/assets/img/screen/mainA/u80.png">11%</span>
        </div>
        <div class="cs-rate-box">
          <span class="cs-rate-label"><img src="@/assets/img/screen/mainA/u79.png">环比</span>
          <span class="cs-rate-num decline"><img src="@/assets/img/screen/mainA/u81.png">0.5%</span>
        </div>
      </div>
    </div>
  </div>
