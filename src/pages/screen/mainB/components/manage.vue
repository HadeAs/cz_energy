    ...
    <div class="cs-right-wrap2">
      <div class="cs-right-wrap3">
        <div class="cs-sub-header">
          ...
          <el-button type="primary" class="btn btn-primary btn-sm">设备管理</el-button>
        </div>
        ...
        <div class="cs-right-box">
          <div class="cs-img-box"><img src="@/assets/img/screen/mainB/u6241.png"></div>
        ...
        <div class="cs-right-box">
          <div class="cs-img-box"><img src="@/assets/img/screen/mainB/u6243.png"></div>
          <div class="cs-info-detail">
            <div class="progress progress-ty">
              <div class="progress-bars">
      ...
      <div class="cs-right-wrap4">
        ...
        <div class="cs-circle-wrap">
          <canvas ref="canvasRef" id="scoreCanvas" width="146" height="146"></canvas>
        </div>
      </div>
    </div>
  </div>
...
const images = ["@/assets/img/screen/mainB/c1.png", "@/assets/img/screen/mainB/c2.png", "@/assets/img/screen/mainB/c3.png", "@/assets/img/screen/mainB/c4.png"]
...
.content {
  ...
  .progress-bar {
    ...
    color: #B4FEFF;
    text-align: right;
    background-image: linear-gradient(to bottom, rgba(0, 249, 255, 0.8) 0%, rgba(0, 249, 255, 0.3) 100%);
